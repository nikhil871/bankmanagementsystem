...
jLabel7.setBounds(150,370,100,30);
 ...
 jRadioButton2.setBounds(370,270,100,30);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Temporaray", "Permanent" }));
     ...
     public void randomAcc()
{
    ...
    jTextField1.setText("IB"+rd.nextInt(10000+1));
}
